    ...
    describe "can detect errors during constructing" $ do
      ...
      it "can detect an error in the transitionTable/not a total function" $ do
        let dfa = newDFA [11,12] 
                         ...
                         [12] 
                         [((11,21),11)
                         ,((11,22),12)] :: Either DFAInvalid (DFA Int Int)
  ...
  describe "Automata instance" $ do
    ...
    describe "delta" $ do
      ...
      it "states should not be modified" $ 
        fmap getStates dfa1 `shouldBe` Right (S.fromList [11,12])
      it "symbols should not be modified" $ 
        fmap getSymbols dfa1 `shouldBe` Right (S.fromList [21,22])
      it "startState should not be modified" $ 
        fmap getStartState dfa1 `shouldBe` Right 11
      it "acceptingStates should not be modified" $ 
        fmap getAcceptingStates dfa1 `shouldBe` Right (S.fromList [12])
      it "transitionTable should not be modified" $ 
        fmap getTransitionTable dfa1 `shouldBe` 
          Right (M.fromList [((11,21),11)
                           ...
                           ,((12,22),12)])
      it "nowState should match" $
        fmap getNowState dfa1 `shouldBe` Right 11
      it "nowState should be modified" $
        fmap getNowState dfa2 `shouldBe` Right 12
    describe "deltaHat" $ do
      let dfaOrg = newDFA [11,12] 
                          ...
                          ,((11,22),12)
                          ,((12,21),12)
                          ,((12,22),11)] :: Either DFAInvalid (DFA Int Int)
      -- Odd number of 12's
      ...
      it "states should not be modified" $ 
        fmap getStates dfa11 `shouldBe` Right (S.fromList [11,12])
      it "symbols should not be modified" $ 
        fmap getSymbols dfa11 `shouldBe` Right (S.fromList [21,22])
      it "startState should not be modified" $ 
        fmap getStartState dfa11 `shouldBe` Right 11
      it "acceptingStates should not be modified" $ 
        fmap getAcceptingStates dfa11 `shouldBe` Right (S.fromList [12])
      it "transitionTable should not be modified" $ 
      ...
      it "nowState should match/dfa11" $
        fmap getNowState dfa11 `shouldBe` Right 11
      it "nowState should match/dfa21" $
        fmap getNowState dfa21 `shouldBe` Right 11
      it "nowState should match/dfa31" $
        fmap getNowState dfa31 `shouldBe` Right 11
      it "nowState should match/dfa41" $
        fmap getNowState dfa41 `shouldBe` Right 11
      it "nowState should match/dfa12" $
        fmap getNowState dfa12 `shouldBe` Right 12
      it "nowState should match/dfa22" $
        fmap getNowState dfa22 `shouldBe` Right 12
      it "nowState should match/dfa32" $
        fmap getNowState dfa32 `shouldBe` Right 12
      it "nowState should match/dfa42" $
        fmap getNowState dfa42 `shouldBe` Right 12   
